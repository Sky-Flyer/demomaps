L.Control.StyledLayerControl = L.Control.Layers.extend({
		...
		_on_resize_window : function(){
			...
			for(var c = 0; c < containers.length; c++ ){
				...
				containers[c].style.maxHeight = (window.innerHeight-80) < this._default_maxHeight ? (window.innerHeight - 80) + "px" : this._default_maxHeight + "px";
			}
		},
		...
		_addItem : function (obj) {
			var label = document.createElement('label'),//SCH change: div -> label
			input,
